...
/* BizForce */
	    	$q = 'SELECT mu.contact_id, mu.accept_status FROM calls_contacts mu WHERE mu.call_id = \''.$focus->id.'\' AND mu.deleted = 0';
...
/* BizForce */
	    	$q = 'SELECT mu.lead_id, mu.accept_status FROM calls_leads mu WHERE mu.call_id = \''.$focus->id.'\' AND mu.deleted = 0';
