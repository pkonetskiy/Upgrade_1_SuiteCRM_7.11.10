...
{
/* BizForce - It's addition to use customer modules in calendar */
    if ($bean->object_name == 'Meeting' || $bean->object_name == 'Call' || $bean->object_name == 'Task'){
/* */
    $bean_id_name = strtolower($bean->object_name).'_id';
/* BizForce */
    }else {
        $bean_id_name = strtolower(substr($bean->object_name,0,strlen($bean->object_name)-1)).'_id';
    }
/* */
